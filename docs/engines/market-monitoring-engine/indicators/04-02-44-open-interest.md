...
The `OpenInterest` struct (`crates/shared/src/indicators/open_interest.rs`) maintains a rolling history of OI values (configurable `oi_lookback` window) and computes:

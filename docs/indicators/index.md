...
| Metric | Count |
|--------|-------|
| Total Registry Entries | 58 |
| Directional (scoring contributors) | 49 |
...
- [Metrics Matrix Reference](../metrics-matrix-reference.md) — Complete indicator classification and signal distribution
- [Monitor Matrices Reference](../monitor-matrices-reference.md) — Six-matrix architecture pipeline

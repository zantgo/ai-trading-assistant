...
pub struct ConfigResponse {
    ...
    pub workspaces: std::collections::HashMap<String, crate::config::WorkspaceSpecificConfig>,
...
#[derive(Debug, Serialize)]
pub struct SessionStatusResponse { pub active: bool, pub currency: Option<String>, pub exchange: Option<String>, pub workspace_count: usize }

// ─── Instance ──────────────────────────────────────────────────

#[derive(Debug, Deserialize)]
pub struct AddWorkspaceRequest { pub base: String, pub quote: String }

#[derive(Debug, Serialize)]
pub struct WorkspaceListResponse { pub workspaces: Vec<crate::registry::WorkspaceSummary>, pub total_count: usize }

#[derive(Debug, Deserialize)]
pub struct WorkspaceDetailQuery { #[serde(default)] pub id: String, #[serde(default)] pub pair_key: Option<String> }
...
#[derive(Debug, Deserialize)]
pub struct WorkspaceManualRequest { pub action: String, pub direction: Option<String>, #[serde(default)] pub price: Option<f64> }

#[derive(Debug, Deserialize)]
pub struct WorkspaceIntervalsRequest { pub slow_seconds: i64, pub normal_seconds: i64, pub fast_seconds: i64 }

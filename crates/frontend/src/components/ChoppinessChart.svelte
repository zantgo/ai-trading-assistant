<script lang="ts">
    ...
    onMount(() => {
        ...
        if (onScreenshotReady) {
            onScreenshotReady(() => {
                ...
                link.download = `${pairKey}_${timeframe}s_choppiness.png`;
        ...
        (async () => {
            ...
            try {
                ...
                console.error('Error bootstrapping Choppiness history:', err);
            }
        })();
    ...
    $effect(() => {
        ...
        const v = iRaw((snap.indicators ?? {}) as IndicatorMap, 'choppiness');

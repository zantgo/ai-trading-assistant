...
pub async fn serve_delete_instance(
    ...
    match registry::delete_instance(&state, &instance_id).await {
        Ok(()) => (
...
pub async fn serve_delete_instance_by_pair(
    ...
    match instance_id {
        Some(id) => match registry::delete_instance(&state, &id).await {
            Ok(()) => (
                axum::http::StatusCode::OK,
...
pub async fn serve_pause_instance(
    ...
    match registry::pause_instance(&state, &instance_id).await {
        Ok(()) => (
            axum::http::StatusCode::OK,
...
pub async fn serve_stop_instance(
    ...
    match registry::stop_instance(&state, &instance_id).await {
        Ok(()) => (
            axum::http::StatusCode::OK,

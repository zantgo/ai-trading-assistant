...
//! `shared::liquidity::estimate_clusters`. The resulting
...
use shared::liquidity::{estimate_clusters, ClusterEstimateInput, LiquidationClusterMatrix};
    ...
    async fn compute_cluster_matrix_returns_ok_with_data() {
        ...
        }
        {
            ...
            for i in 0..50 {
                ...
                hist.push_back(shared::normalized::NormalizedCandle {
                    symbol: "BTC-USDT".to_string(),

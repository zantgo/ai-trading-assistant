...
pub const INDICATORS: &[IndicatorMeta] = &[
    ...
    IndicatorMeta {
        ...
        render: Pane, directional: true, supports_divergence: true,
        signal_types: &[Crossover, Threshold, Divergence, ZeroLineCross], default_weight: 1.0, default_enabled: true,
    ...
    IndicatorMeta {
        ...
        render: Pane, directional: true, supports_divergence: true,
        signal_types: &[Threshold, Divergence, ZeroLineCross], default_weight: 1.0, default_enabled: true,
